  ...
  return (
    <div style={{ paddingBottom: 180 }}>
      <AppBar
        ...
        right={
          selectedCount > 0
            ? <div style={{ fontFamily: MONO, fontSize: 11, color: 'rgba(0,0,0,0.55)' }}>{selectedCount} selected</div>
            : undefined
        }
      />
      ...
      <div style={{ padding: '20px 20px 0' }}>
        <SectionLabel right="required *">date</SectionLabel>
        <input
          type="date"
          value={date}
      ...
      <div style={{ padding: '20px 20px 0' }}>
        ...
        <input
          ...
          style={{
            ...
            fontFamily: UI, fontSize: 13, color: INK,
            background: 'none', border: 'none', outline: 'none',
            borderBottom: RULE, padding: '4px 0 8px',
          }}
        />
